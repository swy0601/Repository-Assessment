...
def read_args():
	...
	parser.add_argument('--data_path', type = str, default = 'D:\Project\Graph\model\KDD2019_HetGNN/data/academic/',
				   help='path to data')
	parser.add_argument('--model_path', type = str, default = 'D:\Project\Graph\model\KDD2019_HetGNN/model_save/',
